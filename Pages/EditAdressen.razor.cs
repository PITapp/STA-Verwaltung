...
{
    public partial class EditAdressen
    {
        [Inject]
        ...
        {
            adressen = await dbSTAVerwaltungService.GetAdressenByAdressNr(AdressNr);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await dbSTAVerwaltungService.UpdateAdressen(AdressNr, adressen);
