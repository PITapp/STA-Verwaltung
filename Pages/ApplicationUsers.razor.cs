...
namespace STAVerwaltung.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<STAVerwaltung.Models.ApplicationUser> users;
        protected RadzenDataGrid<STAVerwaltung.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(STAVerwaltung.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(STAVerwaltung.Models.ApplicationUser user)
        {
            try
            {
